/*This file is input to our main program (check makefile) and is used to check
if all of our tokens are working correctly
...
inline void func(char[] text){
	char[20] sum=text+S;
	printf("The concatenation of the texts are : %s \n",sum);
}
